...
def generate_script(cmd:str, script_path:str, run_dir:str, abci_log_dir:str, ex_id:str, user:str, env:str, hour:int=72, wandb_api_key=''):
    """
    """
