...
from atro.loss import MaxHingeLoss, MaxHingeLossBinary
...
def train(**kwargs):
    ...
    for ep in range(FLAGS.num_epochs):
        ...
        for i, (x,t) in enumerate(train_loader):
            ...
            maxhinge_loss, loss_dict = MHLoss(out_class, t) 
        ...
        for i, (x,t) in enumerate(val_loader):
            ...
            with torch.autograd.no_grad():
                ...
                # evaluation
                evaluator = Evaluator(out_class.view(-1).detach(), t.detach())
