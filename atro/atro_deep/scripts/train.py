...
def train(**kwargs):
    ...
    # loss
    MHRLoss = MaxHingeLossWithRejection(FLAGS.cost)
    ...
    for ep in range(FLAGS.num_epochs):
        ...
        for i, (x,t) in enumerate(train_loader):
            ...
            maxhinge_loss, loss_dict = MHRLoss(out_class, out_reject, t, dataset_builder.num_classes) 
        ...
        for i, (x,t) in enumerate(val_loader):
            ...
            with torch.autograd.no_grad():
                ...
                # evaluation
                evaluator = Evaluator(out_class.detach(), t.detach(), out_reject.detach())
